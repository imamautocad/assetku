...
<head>
    <meta charset="UTF-8">
    <title>PDF Permintaan Barang</title>
    <style>
...
<body>
    <p></p>
        ...
        <h3>Permintaan Barang Consumable</h3>
    <hr /></div>
    ...
    <table class="info-table">
        ...
        <tr> 
            <td class="label"><strong>Nama Pemohon</strong></td>
            <td class="separator">:</td>
        ...
        <tr>
            <td class="label"><strong>Catatan</strong></td>
            <td class="separator">:</td>
            <td>{{ $order->notes ?? '-' }}</td>
        </tr>
    </table>
    ...
    <table class="signature-table">
        <tr>
            ...
            <td><strong>General Affair (GA)</strong></td>
        </tr>
        <tr>
            <td>___________________________<br>{{ $order->user->name }}</td>
            <td>___________________________<br>Tim GA</td>
        </tr>
    </table>
</body>
</html>
