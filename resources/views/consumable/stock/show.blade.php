...
@section('title', 'Detail Input Stock Consumable')
    ...
    <div class="col-md-12">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Detail Input Stock #{{ $order->no_req }}</h3>
            </div>
            <div class="box-body">
                @if(session('error'))
                ...
                <div class="row mb-4">
                    <div class="col-md-2">
                        <label>No.Po</label>
                        <input type="text" class="form-control" value="{{ $order->no_po ?? '-' }}" readonly>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="box-footer left-right">
                    ...
                    <a href="{{ route('consumable.stock.edit', $order->id) }}" class="btn btn-default btn-sm">
