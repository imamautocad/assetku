...
@section('title', 'Edit Consumable Stock')
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    Edit Consumable Stock — <medium>{{ $order->no_req }}</medium>
                </h3>
            </div>

            <form method="POST" action="{{ route('consumable.stock.update', $order->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-2">
                        <label>No.PO</label>
                        <input type="text" name='no_po' class="form-control" value="{{ $order->no_po ?? '-' }}" readonly>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="box-footer left-right">
                    ...
                    <a href="{{ route('consumable.stock.index') }}" class="btn btn-default">
